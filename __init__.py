...
def checkifwin():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Two", "X Wins")
        disable_all_buttons()
    ...
    elif b1["text"] == "O" and b2["text"] == ")" and b3["text"] == "O":
        b1.config(bg="red")
        b2.config(bg="red")
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Two", "O Wins")
        disable_all_buttons()
    ...
    if count == 9 and winner == False:
        messagebox.showinfo("Tic Tac Two", "Its a tie!")
...
def b_click(b):
    ...
    if b["text"] == "" and clicked == True:
        ...
        messagebox.showerror("Tic Tac Two", "That box has already been selected")
...
def reset():
    ...
    clicked = True
    count = 0
    messagebox.showinfo("Tic Tac Two", "Game Start!")
